...
public class Menu2 extends View
{
    ...
    public void initGraphicObjects()
    {
        ...
        tabGO = new GraphicObject[7];
        tabGO[0] = new Background(se, 0);
        tabGO[1] = new Text(se, se.getW()/2 - 300, se.getH()/2 - 400, 600, 350, 150, "Mode de jeu", "Miama.ttf");
        /*tabGO[3] = new Text(se, se.getW()/2 - 200, se.getH()/2 - 125, 400, 100, 80, "Normale en ligne", "Miama.ttf");
        tabGO[2] = new Button(se, (Text)tabGO[3], 3);
        tabGO[5] = new Text(se, se.getW()/2 - 200, se.getH()/2, 400, 100, 80, "Classique en ligne", "Miama.ttf");
        tabGO[4] = new Button(se, (Text)tabGO[5], 4);
        tabGO[7] = new Text(se, se.getW()/2 - 200, se.getH()/2 + 125, 400, 100, 80, "Normale en local", "Miama.ttf");
        tabGO[6] = new Button(se, (Text)tabGO[7], 5);
        tabGO[9] = new Text(se, se.getW()/2 - 200, se.getH()/2 + 250, 400, 100, 80, "Classique en local", "Miama.ttf");
        ...
        tabGO[6] = new Button(se, 10, 10, 0, 1, 2);
    }
}