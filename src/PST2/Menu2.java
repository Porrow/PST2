...
public class Menu2 extends View
{
    ...
    public void initGraphicObjects()
    {
        ...
        tabGO[1] = new Text(se, se.getW()/2 - 300, se.getH()/2 - 440, 600, 350, 150, "Mode de jeu", "Miama.ttf", 0);
        tabGO[3] = new Text(se, se.getW()/2 - 200, se.getH()/2 - 125, 400, 100, 70, "Normale en ligne", "Miama.ttf", 0);
        tabGO[2] = new Button(se, (Text)tabGO[3], 3);
        tabGO[5] = new Text(se, se.getW()/2 - 200, se.getH()/2, 400, 100, 70, "Classique en ligne", "Miama.ttf", 0);
        tabGO[4] = new Button(se, (Text)tabGO[5], 4);
        tabGO[7] = new Text(se, se.getW()/2 - 200, se.getH()/2 + 125, 400, 100, 70, "Normale en local", "Miama.ttf", 0);
        tabGO[6] = new Button(se, (Text)tabGO[7], 5);
        tabGO[9] = new Text(se, se.getW()/2 - 200, se.getH()/2 + 250, 400, 100, 70, "Classique en local", "Miama.ttf", 0);
